...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2025 a las 18:16:01
...
--
-- Estructura de tabla para la tabla `materias_catalogo`
--
...
--
-- Volcado de datos para la tabla `materias_catalogo`
--

INSERT INTO `materias_catalogo` (`id`, `nombre`, `area_id`, `activo`) VALUES
(1, 'Matemática', 1, 1),
(2, 'Física', 1, 1),
(3, 'Lengua y Literatura', 2, 1),
(4, 'Inglés', 2, 1),
(5, 'Historia', 3, 1),
(6, 'Geografía', 3, 1),
(7, 'Derecho del trabajo', 3, 1),
(8, 'Ciencias Sociales', 3, 1),
(9, 'Construcción de Ciudadanía', 3, 1),
(10, 'Economía', 3, 1),
(11, 'Biología', 4, 1),
(12, 'Química', 4, 1),
(13, 'Ciencias Naturales', 4, 1),
(14, 'Arte', 5, 1),
(15, 'Música', 5, 1),
(16, 'Educación Física', 6, 1),
(17, 'Salud e higiene', 6, 1);
...
(1, 1, NULL, 'Lunes', '07:35:00', '09:35:00', 1),
(2, 1, NULL, 'Lunes', '09:55:00', '11:55:00', 1),
...
(41, 3, NULL, 'Lunes', '07:35:00', '09:35:00', 1),
